...
void MainWindow::on_pushButtonMovingX_clicked() {
  controller_->AfinMove(ui_->doubleSpinBoxMoving->value(), AXISX);
  ui_->widget->BufferFilling();
  ui_->widget->update();
}

void MainWindow::on_pushButtonMovingY_clicked() {
  controller_->AfinMove(ui_->doubleSpinBoxMoving->value(), AXISY);
  ui_->widget->BufferFilling();
  ui_->widget->update();
}

void MainWindow::on_pushButtonMovingZ_clicked() {
  controller_->AfinMove(ui_->doubleSpinBoxMoving->value(), AXISZ);
  ui_->widget->BufferFilling();
  ui_->widget->update();
}

void MainWindow::on_pushButtonRotateX_clicked() {
  controller_->AfinRotate(ui_->doubleSpinBoxRotate->value(), AXISX);
  ui_->widget->BufferFilling();
  ui_->widget->update();
}

void MainWindow::on_pushButtonRotateY_clicked() {
  controller_->AfinRotate(ui_->doubleSpinBoxRotate->value(), AXISY);
  ui_->widget->BufferFilling();
  ui_->widget->update();
}

void MainWindow::on_pushButtonRotateZ_clicked() {
  controller_->AfinRotate(ui_->doubleSpinBoxRotate->value(), AXISZ);
  ui_->widget->BufferFilling();
  ui_->widget->update();
}

void MainWindow::on_pushButtonPlusScale_clicked() {
  controller_->AfinScale(1.1);
  ui_->widget->BufferFilling();
  ui_->widget->update();
}

void MainWindow::on_pushButtonMinusScale_clicked() {
  controller_->AfinScale(0.9);
  ui_->widget->BufferFilling();
  ui_->widget->update();
}
